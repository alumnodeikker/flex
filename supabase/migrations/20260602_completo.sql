...
insert into public.productos (nombre, descripcion, categoria, precio, imagen, disponible) values
  ('Cerveza Artesana', 'Cerveza local', 'Bebida', 4.50, 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400', true),
  ('Gin Tonic Premium', 'Gin premium con tónica', 'Bebida', 9.00, 'https://images.unsplash.com/photo-1560512823-829485b8bf24?w=400', true),
  ('Agua mineral', 'Agua mineral', 'Bebida', 2.00, 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400', true),
  ('Mojito', 'Bebida refrescante', 'Bebida', 8.50, 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400', true),
  ('Nachos con guacamole', 'Nachos crujientes', 'Comida', 7.00, 'https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?w=400', true),
  ('Tabla de quesos', 'Selección de quesos', 'Comida', 12.00, 'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=400', true),
  ('Alitas BBQ', 'Alitas a la BBQ', 'Comida', 9.50, 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=400', true),
  ('Hamburguesa Flex', 'Hamburguesa especial', 'Comida', 11.00, 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400', true)
on conflict do nothing;
